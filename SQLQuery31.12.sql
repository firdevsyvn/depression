% Bunun veri analizi ile ilgisi yok tabloyu aktarýrken age sutünundaki 28.0 girilmiþ yaþlarý 280 olarak yazmýþtý düzelttim
UPDATE ['Student Depression Dataset$'] SET Age = LEFT(Age ,2) WHERE ÝD >=30;
